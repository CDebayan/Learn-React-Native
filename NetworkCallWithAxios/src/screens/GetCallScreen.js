...
import {getStudent} from '../store/actions/GetCallAction';
import {ERROR, LOADING, SUCCESS} from '../store/ActionTypes';
import {GlobalStyles} from '../styles/GlobalStyles';
import Colors from '../constants/Colors';

export const GET_CALL_SCREEN = 'GetCallScreen';

const GetCallScreen = () => {
    const state = useSelector(state => state.getCallReducer);
